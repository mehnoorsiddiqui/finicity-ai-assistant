...
| `constraints` | [`PayrollReportConstraintsOut \| undefined`](../../doc/models/payroll-report-constraints-out.md) | Optional | - |
...
```json
{
  ...
  "constraints": {
    "payrollData": {
      "payrollDataRetrievalId": "payrollDataRetrievalId4",
      "employerNames": [
        "employerNames2"
      ],
      "reportId": "reportId8"
