...
|  --- | --- | --- | --- |
| `dateRange` | [`ConsumerAttributesDataDateRange`](../../doc/models/consumer-attributes-data-date-range.md) | Required | - |
| `income` | [`ConsumerAttributesDataIncome`](../../doc/models/consumer-attributes-data-income.md) | Required | - |
| `expenses` | [`ConsumerAttributesDataExpenses`](../../doc/models/consumer-attributes-data-expenses.md) | Required | - |
| `netAmount` | [`ConsumerAttributesDataNetAmount`](../../doc/models/consumer-attributes-data-net-amount.md) | Required | - |
| `nsf` | [`ConsumerAttributesDataNSF`](../../doc/models/consumer-attributes-data-nsf.md) | Required | - |
| `assets` | [`ConsumerAttributesDataAssets`](../../doc/models/consumer-attributes-data-assets.md) | Required | - |
| `liabilities` | [`ConsumerAttributesDataLiabilities`](../../doc/models/consumer-attributes-data-liabilities.md) | Required | - |
