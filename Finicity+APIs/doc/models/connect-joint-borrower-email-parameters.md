...
# Connect Joint Borrower Email Parameters
...
| `borrowers` | [`Borrower[]`](../../doc/models/borrower.md) | Required | (MVS) Array of borrowers to pass the primary and joint borrower's customer and consumer IDs |
...
| `email` | [`EmailOptions`](../../doc/models/email-options.md) | Required | Configuration for the Connect email's sent to customers |
