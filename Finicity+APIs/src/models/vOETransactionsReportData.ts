...
import {
  ...
  vOETransactionsReportConstraintsOutSchema,
} from './vOETransactionsReportConstraintsOut';

export interface VOETransactionsReportData {
...
export const vOETransactionsReportDataSchema: Schema<VOETransactionsReportData> = object(
  {
    id: ['id', string()],
    ...
    constraints: [
      'constraints',
      optional(lazy(() => vOETransactionsReportConstraintsOutSchema)),
    ],
  }
);
