...
import {
  ...
  vOIEWithTXVerifyReportConstraintsOutSchema,
} from './vOIEWithTXVerifyReportConstraintsOut';

export interface VOIEPaystubWithTXVerifyReportData {
...
export const vOIEPaystubWithTXVerifyReportDataSchema: Schema<VOIEPaystubWithTXVerifyReportData> = object(
  {
    id: ['id', string()],
    ...
    constraints: [
      'constraints',
      optional(lazy(() => vOIEWithTXVerifyReportConstraintsOutSchema)),
    ],
  }
);
